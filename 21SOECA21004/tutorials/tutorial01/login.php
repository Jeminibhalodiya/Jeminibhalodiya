...
<html lang="en">
  <head>
    ...
    <title>Bootstrap Login <Form></Form></title>
  </head>
  <body>
    <div class="text-center">
        ...
        <input type="email" id="emailaddress" placeholder="EmailAddress" required autofocus></br></br>
        
        <label class="sr-only">Password</label>
        <input type="password" id="password" placeholder="Password" required autofocus></br></br>
		<a href="Registration.php">Register</a>
        <button class="btn btn-ig btn-primary";text-align="center">Login</button>
